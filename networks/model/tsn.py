  ...
  def _prepare_base_model(self, base_model):
    ...
    if 'resnet' in base_model:
      ...
      if self.is_shift:
        ...
        from networks.model.tsn.temporal_shift import make_temporal_shift
        make_temporal_shift(self.base_model, self.num_segments,
                  n_div=self.shift_div, place=self.shift_place, temporal_pool=self.temporal_pool)

      if self.non_local:
        print('Adding non-local module...')
        from networks.model.tsn.non_local import make_non_local
...
if __name__ == "__main__":
  ...
  tsn = TSN(num_class, num_segments, modality, base_model, consensus_type=consensus_type, dropout=dropout,
  ...
  input = torch.randn(64, 10, 224, 224, 3)
  output = tsn(input)
  print(output.size())
  print(output)
