...
from networks.model.audio_resnet.eres2net import ReLU, conv1x1, conv3x3
...
def Res2Net10_Base(feat_dim,
                   embed_dim,
                   pooling_func='TSTP',
                   two_emb_layer=False):
    return Res2Net(32, [1, 1, 1, 1],
                   feat_dim=feat_dim,
                   embed_dim=embed_dim,
                   pooling_func=pooling_func,
                   two_emb_layer=two_emb_layer)

def Res2Net18_Base(feat_dim,
                   embed_dim,
                   pooling_func='TSTP',
                   two_emb_layer=False):
    return Res2Net(32, [2, 2, 2, 2],
                   feat_dim=feat_dim,
                   embed_dim=embed_dim,
                   pooling_func=pooling_func,
                   two_emb_layer=two_emb_layer)
...
def get_res2net(resnum, feat_dim, embed_dim, pooling_func='TSTP', two_emb_layer=False):
    if resnum == 10:
        return Res2Net10_Base(feat_dim, embed_dim, pooling_func, two_emb_layer)
    elif resnum == 18:
        return Res2Net18_Base(feat_dim, embed_dim, pooling_func, two_emb_layer)
    elif resnum == 34:
        return Res2Net34_Base(feat_dim, embed_dim, pooling_func, two_emb_layer)
    else:
