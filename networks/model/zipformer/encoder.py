...
import torch
from networks.model.zipformer.encoder_interface import EncoderInterface
from networks.model.ops.mask import k2_make_pad_mask
from networks.model.zipformer.subsampling import Conv2dSubsampling
from networks.model.zipformer.scaling import (
...
class Zipformer2(EncoderInterface):
    ...
    def __init__(
        ...
        self.encoder_embed = Conv2dSubsampling(in_channels=feature_dim, out_channels=encoder_dim[0], dropout=ScheduledFloat((0.0, 0.3), (20000.0, 0.1)))
    ...
    def output_size(self) -> int:
        return self.encoder_unmasked_dim[0] # 注意返回不是tupel是int
    ...
    def forward(
        ...
        src_key_padding_mask = k2_make_pad_mask(x_lens)
