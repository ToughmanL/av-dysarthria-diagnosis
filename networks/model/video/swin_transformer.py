...
class PatchEmbed(nn.Module):
    ...
    Args:
        img_size (int): Image size.  Default: 96.
    ...
    def __init__(self, img_size=96, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        super().__init__()
...
class SwinTransformer(nn.Module):
    ...
    Args:
        img_size (int | tuple(int)): Input image size. Default 96
    ...
    def __init__(self, img_size=96, patch_size=4, in_chans=3, num_classes=1000,
                 embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
                 window_size=6, mlp_ratio=4., num_segments=1, qkv_bias=True, qk_scale=None,
    ...
    def forward(
        ...
        input = video
        input = self.extract_feats(input)
...
if __name__ == "__main__":
    model = SwinTransformer(
        img_size=96, patch_size=4, in_chans=3, num_classes=2, embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24], window_size=6, mlp_ratio=4., num_segments=1,qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1, norm_layer=nn.LayerNorm, ape=False, patch_norm=True, use_checkpoint=False, fused_window_process=False)
    print(model)
    print(model.flops())
