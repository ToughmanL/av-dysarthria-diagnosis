...
class ResNet3D(nn.Module):
    def __init__(self,
        ...
        self.fc = nn.Linear(block_inplanes[3] * block.expansion, out_dim)
...
# Path: examples/MSDM/240428/wenet/transformer/convolution.py
if __name__ == "__main__":
    model = generate_model(10)
    print(model)
    x1 = torch.randn(8, 3, 16, 96, 96)
    x2 = torch.randn(8, 3, 21, 96, 96)
    y1 = model(x1)
    y2 = model(x2)
    print(y1.size())
    print(y2.size())