...
from networks.model.squeezeformer.subsampling \
    import DepthwiseConv2dSubsampling4, TimeReductionLayer1D, \
    TimeReductionLayer2D, TimeReductionLayerStream
from networks.model.squeezeformer.encoder_layer import SqueezeformerEncoderLayer
...
from networks.model.squeezeformer.attention import RelPositionMultiHeadedAttention
from networks.model.squeezeformer.positionwise_feed_forward \
    import PositionwiseFeedForward
from networks.model.squeezeformer.convolution import ConvolutionModule
from networks.utils.mask import make_pad_mask, add_optional_chunk_mask
from networks.utils.class_utils import WENET_ACTIVATION_CLASSES
